...
<head>
  ...
  <meta
    name="description"
    content="Sign up to see the tours and planned trips to Mestia." />
...
<body>
  ...
  require_once __DIR__ . '/../Backend/models/RegisterRequest.php';
  ...
  if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Basic manual confirm password check
    if ($password !== $confirmPassword) {
      ...
      if ($response->isSuccess) {
        $success = true;
        // You can also log in the user immediately here if you'd like
    ...
    <div class="row">
      <?php if ($success): ?>
        <div class="row message">
          <p class="form-success">Registration successful! <a href="signIn.php">Sign in here.</a></p>
        </div>
